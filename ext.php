...
class ext extends base
{
	...
	*
	* @var string Require 3.2 due to updated 3.2 syntax
	*
	* @return bool
	* @access public
	*/
	public function is_enableable()
	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/trimsubject');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/trimsubject', 'ext_enable_error');
			}
		}
